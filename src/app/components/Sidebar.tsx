...
const Sidebar = () => {
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          />
          <path
            d="M20 21V19.5C20 18.5 19.5 17.5 18.5 17"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          />
          <path
            d="M23 21V19C23 17.9391 22.5786 16.9217 21.8284 16.1716C21.0783 15.4214 20.0609 15 19 15H17.5"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  return (
    <div className="w-64 h-screen bg-sidebar-bg border-r border-border-color flex flex-col">
      {/* Header */}
      <div className="p-6 border-b border-border-color">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold text-foreground">Lendglow</h1>
          </div>
      ...
      <div className="p-4 border-t border-border-color">
        <ul className="space-y-2">
          <li>
            <button className="w-full flex items-center px-4 py-3 rounded-lg text-gray-300 hover:bg-hover-bg hover:text-white transition-colors">
              <span className="mr-3">
                <svg
                  width="20"
                  height="20"
